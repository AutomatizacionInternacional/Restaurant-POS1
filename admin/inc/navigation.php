...
<aside class="main-sidebar sidebar-light-indigo navbar-light elevation-4 sidebar-no-expand">
  <!-- Brand Logo -->
  <a href="<?php echo base_url ?>admin" class="brand-link bg-indigo text-sm">
          ...
          <nav class="mt-1">
            <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <?php if ($_settings->userdata('type') != 3) : ?>
                <li class="nav-item dropdown">
                  <a href="./?page=table" class="nav-link nav-table">
                  ...
                  <ul class="nav nav-treeview" style="display: none;">
                    <li class="nav-item">
                      <a href="./?page=reports" class="nav-link tree-item nav-reports">
                        ...
                        <p>Reporte diarío de Ventas</p>
                      </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-header">ConfiguroWeb</li>
                <li class="nav-item dropdown">
...
<script>
  $(document).ready(function() {
    ...
    $('.nav-link.active').addClass('bg-gradient-indigo')
