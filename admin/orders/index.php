		...
		<div class="container-fluid">
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<tbody>
					...
					$qry = $conn->query("SELECT order_list.*, COALESCE(rest_table.tablename, 'Sin mesa') AS tablename FROM `order_list` LEFT JOIN rest_table ON order_list.table_id = rest_table.tableid OR rest_table.tableid IS NULL  {$uwhere} order by abs(unix_timestamp(date_created)) desc ");
